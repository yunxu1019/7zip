...
cl /c /O2 /I"%LZMA_DIR%\C" /I"%VC%\include" %LZMA_DIR%\wasm\LzmaUnC.c LzmaDec.c LzFindMt.c LzFind.c Alloc.c LzFindOpt.c Threads.c /Gz /MD /D_WIN32 /DNO_ASM
lib /OUT:%OUTPUT_DIR%\LzmaLib.lib *.obj
...
if exist %OUTPUT_DIR%\LzmaLib.lib (
    echo Build successful: LzmaLib.lib and LzmaLib.inc created in %OUTPUT_DIR%
) else (
    echo Build failed!
    exit /b 1
)
